...
public class TestCollectionArrayList1 {
	...
	public static void main(String args[]) {
		...
		listaDeDisciplinas.add(new Disciplina(1, "Java", "Estudo de Java", Periodo.NOITE));
		listaDeDisciplinas.add(new Disciplina(2, "Algoritmo", "Estudo de Algoritmo", Periodo.NOITE));
